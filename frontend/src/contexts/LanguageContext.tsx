...
const translations = {
  en: {
    ...
    enterOrganizationName: 'e.g. Acme Corp',
    organizationRut: 'Tax ID / RUT',
    enterRut: '12.345.678-9',
  ...
  es: {
    ...
    fillDetailsToCreate: 'Completa los datos para crear tu cuenta',
    enterEmail: 'tu@correo.com',
    enterPassword: 'Ingresa tu contraseña',
    username: 'Nombre de usuario',
    enterUsername: 'Elige un nombre de usuario',
    organizationName: 'Nombre de la organización',
    enterOrganizationName: 'Ej. Empresa S.A.',
    organizationRut: 'RUT de la organización',
    enterRut: '12.345.678-9',
