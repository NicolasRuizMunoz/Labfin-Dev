          ...
          <Card className="border-financial/20 bg-gradient-success/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Info className="w-5 h-5 text-financial" />
                Key Insights
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-semibold mb-2">Understanding Your Mortgage:</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Early payments are mostly interest, later payments mostly principal</li>
                    <li>• {downPaymentPercent >= 20 ? 'Your 20%+ down payment avoids PMI' : 'Consider 20% down payment to avoid PMI'}</li>
                    <li>• Total interest: {formatCurrency(calculations.totalInterest)} ({((calculations.totalInterest / calculations.loanAmount) * 100).toFixed(0)}% of loan amount)</li>
                    <li>• Each 1% rate increase adds ~{formatCurrency((calculations.loanAmount * 0.01 / 12) * loanTermYears * 12)} in total interest</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Optimization Tips:</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Extra principal payments reduce total interest significantly</li>
                    <li>• Bi-weekly payments (26/year) = 13 monthly payments annually</li>
                    <li>• Refinancing when rates drop 0.75%+ often saves money</li>
                    <li>• 15-year loans have higher payments but much lower total interest</li>
                  </ul>
                </div>
              </div>
            </CardContent>
