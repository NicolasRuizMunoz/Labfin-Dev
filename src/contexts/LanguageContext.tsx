...
const translations = {
  en: {
    ...
    joinLabFin: 'Join LabFin',
    signInToContinue: 'Sign in to continue your financial learning journey',
    createAccountToStart: 'Create an account to start building financial knowledge',
    signIn: 'Sign In',
    signUp: 'Sign Up',
    enterCredentials: 'Enter your credentials to access your account',
    fillDetailsToCreate: 'Fill in your details to create your account',
    username: 'Username',
    ...
    respondToRequests: 'Respond to incoming friend requests',
    accept: 'Accept',
    decline: 'Decline',
    ...
    // Daily Test - Social
    dailyFinanceTest: 'Daily Finance Test',
    dailyTestDescription: 'Test your financial knowledge and compete with friends',
    ...
    alreadyTakenToday: 'You have already taken today\'s test',
  ...
  es: {
    ...
    joinLabFin: 'Únete a LabFin',
    signInToContinue: 'Inicia sesión para continuar tu viaje de aprendizaje financiero',
    createAccountToStart: 'Crea una cuenta para comenzar a construir conocimiento financiero',
    signIn: 'Iniciar Sesión',
    signUp: 'Registrarse',
    enterCredentials: 'Ingresa tus credenciales para acceder a tu cuenta',
    fillDetailsToCreate: 'Completa tus datos para crear tu cuenta',
    ...
    searchForFriends: 'Busca amigos para competir',
    ...
    respondToRequests: 'Responde a las solicitudes de amistad entrantes',
    accept: 'Aceptar',
    decline: 'Rechazar',
    ...
    // Additional Spanish translations for daily test social features
    loading: 'Cargando',
    authRequired: 'Autenticación Requerida',
    signInToAccess: 'Por favor inicia sesión para acceder al test diario y competir con amigos',
    alreadyTakenToday: 'Ya has tomado el test de hoy',
