...
MODEL_SERVICE_URL = os.getenv("MODEL_SERVICE_URL", "http://model_service:8080/rag/answer")
MODEL_SERVICE_TIMEOUT = float(os.getenv("MODEL_SERVICE_TIMEOUT", "300"))
MODEL_SERVICE_MAX_SOURCES = int(os.getenv("MODEL_SERVICE_MAX_SOURCES", "5"))