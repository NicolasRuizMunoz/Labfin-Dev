...
class ChatSession(Base):
    """
    Representa una única conversación.
    Vinculada a una organización (para aislamiento de datos)
    y a un usuario (para que el usuario vea su historial).
    """
...
class ChatMessage(Base):
    """
    Un único mensaje (de 'user' o 'assistant') dentro de una sesión.
    """
